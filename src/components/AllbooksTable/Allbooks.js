  ...
  const booksColumns = [
    {
      ...
      renderCell: (params) => {
        return (
          <img
            src={`${process.env.REACT_APP_PATH}/images/${params.row.image}`}
            ...
            >
              <button
                className={`${adminAllBooksStyle.changeStatusBtn} ${
                  ...
                  adminAllBooksStyle.disabledBtn
                }`}
  ...
  const authorsColumns = [
...

    {
      ...
      renderCell: (params) => {
        return (
          <span
            className={adminAllBooksStyle.buttonContainer}
        ...
        <Box sx={style}>
          ...
          >
            ...
            <div className={style.inputContainer}>
              ...
              >
                <option
                  value={library.status === "active" ? "Active" : "inActive"}
                ></option>
                <option
                  value={library.status === "active" ? "inActive" : "Active"}
                ></option>
              </select>
            </div>
